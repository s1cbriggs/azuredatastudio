...
export async function createServer(ipcHandlePrefix: string, onRequest: (req: any, res: http.ServerResponse) => Promise<void> | void) {
...
export class Server {
	...
	constructor(public ipcHandlePath: string, onRequest: (req: any, res: http.ServerResponse) => Promise<void> | void) {
...
export async function readJSON<T>(req: any) {
